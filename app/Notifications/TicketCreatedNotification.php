...
class TicketCreatedNotification extends Notification implements ShouldQueue
{
    ...
    {
        $subject = $this->ticketReference.' — '.__('Demande enregistrée');
        ...
        return $mail
            ...
            ->view('emails.notifications.ticket-status', [
                'subject' => $subject,
                'heading' => __('Demande enregistrée'),
                'bodyText' => __('Votre demande a bien été enregistrée. Nous reviendrons vers vous rapidement.'),
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'body_excerpt' => __('Votre demande a bien été enregistrée.'),
        ];
    }
