...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fb_selected_form_id): ?>
        <nav class="builder-tabs-scroll overflow-x-auto overscroll-x-contain px-3 sm:px-5 lg:px-6" aria-label="<?php echo e(__('forms_builder.tabs_label')); ?>">
            <div class="flex min-w-max gap-0">
                <button type="button" wire:click="setActiveTab('champs')" wire:loading.attr="disabled" wire:target="setActiveTab"
                        class="relative whitespace-nowrap px-3 py-2.5 text-xs font-semibold transition-colors <?php echo e($activeTab === 'champs' ? 'text-slate-900' : 'text-slate-400 hover:text-slate-600'); ?>">
                ...
                <button type="button" wire:click="setActiveTab('assignations')" wire:loading.attr="disabled" wire:target="setActiveTab"
                        class="relative flex items-center gap-1.5 whitespace-nowrap px-3 py-2.5 text-xs font-semibold transition-colors <?php echo e($activeTab === 'assignations' ? 'text-slate-900' : 'text-slate-400 hover:text-slate-600'); ?>">
                ...
                <button type="button" wire:click="setActiveTab('reponses')" wire:loading.attr="disabled" wire:target="setActiveTab"
                        class="relative whitespace-nowrap px-3 py-2.5 text-xs font-semibold transition-colors <?php echo e($activeTab === 'reponses' ? 'text-slate-900' : 'text-slate-400 hover:text-slate-600'); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'champs'): ?>
        ...
        <aside class="hidden lg:flex fb-sidebar-properties bg-white border-l border-slate-100 flex-col shrink-0 z-10 transition-[width] duration-200 ease-out">
            <div class="flex-1 overflow-y-auto custom-scrollbar p-4 min-[1100px]:p-5 xl:p-6" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('props-desktop-{{ $fb_selected_field_id ?? \'none\' }}', get_defined_vars()); ?>wire:key="props-desktop-<?php echo e($fb_selected_field_id ?? 'none'); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['wire:model.defer' => 'assign_user_id','wire:loading.attr' => 'disabled','wire:target' => 'assignForm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.defer' => 'assign_user_id','wire:loading.attr' => 'disabled','wire:target' => 'assignForm']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                        ...
                        <div x-show="assignMode === 'function'" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <?php if (isset($component)) { $__componentOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['wire:model.defer' => 'assign_function_id','wire:loading.attr' => 'disabled','wire:target' => 'assignForm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.defer' => 'assign_function_id','wire:loading.attr' => 'disabled','wire:target' => 'assignForm']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div class="mx-auto w-full max-w-4xl px-3 py-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] sm:px-6 sm:py-8 lg:px-8 space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-slate-900"><?php echo e(__('forms_builder.responses_tab')); ?></h3>
                            <p class="text-[11px] text-slate-400"><?php echo e(trans_choice('forms_builder.response_count', $responsesTotal, ['count' => $responsesTotal])); ?></p>
                        </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedForm && $responsesTotal > 0): ?>
                        <a href="<?php echo e(route('admin.forms.responses', ['form' => $selectedForm->id])); ?>"
                           wire:navigate.hover
                           ...
                           style="background: var(--accent);">
                            ...
                            <?php echo e(__('forms_builder.view_all_responses')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentResponses->isNotEmpty()): ?>
                    <div class="rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentResponses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $response): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php
                            ...
                            ?>
                            <div class="px-4 sm:px-5 py-3 flex items-center justify-between gap-3 <?php echo e(!$loop->last ? 'border-b border-slate-100/80' : ''); ?>">
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <p class="text-[10px] text-slate-400 mt-0.5">
                                        ...
                                        <span class="text-slate-300 mx-1">&middot;</span>
                                        v<?php echo e($response->form_version); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($responsesTotal > 5 && $selectedForm): ?>
                        <div class="text-center">
                            <a href="<?php echo e(route('admin.forms.responses', ['form' => $selectedForm->id])); ?>"
                               ...
                               class="inline-flex items-center gap-1.5 text-xs font-medium text-slate-500 hover:text-slate-700 transition-colors">
                                ...
                                <?php echo e(__('forms_builder.view_remaining_responses', ['count' => $responsesTotal - 5])); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="rounded-2xl border border-slate-100 bg-white shadow-sm p-8 sm:p-10 text-center">
                        ...
                        <h3 class="text-sm font-semibold text-slate-600 mb-1"><?php echo e(__('forms_builder.no_responses')); ?></h3>
                        <p class="text-xs text-slate-400"><?php echo e(__('forms_builder.no_responses_hint')); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    ...
    <div class="lg:hidden fixed inset-0 z-[100]" x-show="paletteDrawer" x-cloak style="display:none;">
        ...
        >
            <div class="flex h-12 shrink-0 items-center justify-end border-b border-slate-50 px-3">
                <button type="button" @click="paletteDrawer = false" class="rounded-lg p-1.5 text-slate-400 transition hover:bg-slate-50 hover:text-slate-600" aria-label="<?php echo e(__('forms_builder.close')); ?>">
                    <iconify-icon icon="solar:close-circle-linear" width="16"></iconify-icon>
                </button>
            </div>
            <div class="flex min-h-0 flex-1 flex-col overflow-hidden">
                <?php echo $__env->make('livewire.admin.form-builder-palette', ['paletteDrawerEmbed' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
    ...
    <div class="lg:hidden fixed inset-0 z-[100]" x-show="propsDrawer" x-cloak style="display:none;">
        ...
        >
            ...
            <div class="flex-1 overflow-y-auto overscroll-y-contain custom-scrollbar p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))]" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('props-mobile-{{ $fb_selected_field_id ?? \'none\' }}', get_defined_vars()); ?>wire:key="props-mobile-<?php echo e($fb_selected_field_id ?? 'none'); ?>">
                <?php echo $__env->make('livewire.admin.form-builder-properties', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\livewire\admin\form-builder.blade.php ENDPATH**/ ?>