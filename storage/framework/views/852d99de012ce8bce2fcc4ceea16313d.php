...
<head>
    ...
    <title>Code de vérification — <?php echo e($appName); ?></title>
    <style>
...
<body style="margin:0; padding:0; background-color:#f4f7f5; width:100%;">
    ...
    <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all;">
        Votre code de vérification <?php echo e($appName); ?> : <?php echo e($code); ?> — valable <?php echo e($expiresMinutes); ?> min
                                ...
                                <tr>
                                    <td align="center" style="padding:28px 32px 8px 32px;">
                                        ...
                                        <div style="margin-top:14px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; font-size:13px; color:#6b7280;">
                                            Ce code expire dans <strong style="color:#111827;"><?php echo e($expiresMinutes); ?> minute<?php echo e($expiresMinutes > 1 ? 's' : ''); ?></strong>
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\emails\auth\email-verification-otp.blade.php ENDPATH**/ ?>