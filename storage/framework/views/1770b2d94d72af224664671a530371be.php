    ...
    <div class="flex items-start justify-center <?php echo e($embedMode ? 'p-0 min-h-0' : 'min-h-[calc(100vh-7rem)] py-8 sm:py-12 px-4 sm:px-6'); ?>">
        <div class="w-full <?php echo e($embedMode ? 'max-w-full' : 'max-w-2xl'); ?> mnx-animate-in">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('public_form_success')): ?>
                <div class="mnx-card rounded-2xl border border-white/60 shadow-xl <?php echo e($embedMode ? 'p-8' : 'p-10 sm:p-14'); ?> mnx-animate-in"
                    ...
                    <div class="text-center">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight transition-all duration-500 delay-200"
                            ...
                            <?php echo e(__('public_form.success_title')); ?>
                    ...
                    <div class="mt-8 rounded-xl border border-slate-100 bg-slate-50/50 divide-y divide-slate-100 transition-all duration-500 delay-[350ms]"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('public_form_ticket_ref')): ?>
                            <div class="flex items-center justify-between px-5 py-3.5">
                                <div class="flex items-center gap-2.5 text-sm text-slate-600">
                                    ...
                                    <?php echo e(__('public_form.ticket_reference')); ?>

                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-bold text-slate-900"><?php echo e(session('public_form_ticket_ref')); ?></span>
                                    <button type="button"
                                            @click="navigator.clipboard.writeText('<?php echo e(session('public_form_ticket_ref')); ?>'); copied = true; setTimeout(() => copied = false, 2000)"
                                            class="p-1 rounded-md text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors"
                                            :title="copied ? '<?php echo e(__('public_form.copied')); ?>' : '<?php echo e(__('public_form.copy')); ?>'">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('public_form_response_ref')): ?>
                            <div class="flex items-center justify-between px-5 py-3.5">
                                <div class="flex items-center gap-2.5 text-sm text-slate-600">
                                    <iconify-icon icon="solar:document-text-bold" width="17" class="text-slate-400"></iconify-icon>
                                    <?php echo e(__('public_form.response_reference')); ?>

                                </div>
                                <span class="text-sm font-semibold text-slate-700"><?php echo e(session('public_form_response_ref')); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('public_form_email')): ?>
                            <div class="flex items-center justify-between px-5 py-3.5">
                                <div class="flex items-center gap-2.5 text-sm text-slate-600">
                                    <iconify-icon icon="solar:letter-bold" width="17" class="text-slate-400"></iconify-icon>
                                    <?php echo e(__('public_form.confirmation_email')); ?>

                                </div>
                                <span class="text-sm font-semibold text-slate-700"><?php echo e(session('public_form_email')); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="mt-5 rounded-xl border border-blue-100 bg-blue-50/50 px-5 py-4 transition-all duration-500 delay-[400ms]"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="text-[13px] text-blue-800 leading-relaxed">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('public_form_ticket_ref')): ?>
                                    <?php echo e(__('public_form.followup_with_ticket', ['ref' => session('public_form_ticket_ref'), 'org' => session('public_form_org_name', '')])); ?>

                                <?php else: ?>
                                    <?php echo e(__('public_form.followup_no_ticket', ['org' => session('public_form_org_name', '')])); ?>
                    ...
                    <div class="mt-8 text-center transition-all duration-500 delay-500"
                        ...
                        <a href="<?php echo e(request()->url()); ?>"
                           ...
                           style="background: var(--accent);">
                            ...
                            <?php echo e(__('public_form.submit_another')); ?>
