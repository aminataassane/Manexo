<div class="discussion-composer shrink-0 border-t border-slate-200 bg-white/95 p-1.5 sm:p-2.5 z-10 safe-area-pb min-w-0 overflow-hidden backdrop-blur" data-composer>
    <div class="mx-auto max-w-3xl min-w-0">
        ...
        x-data="{
            ...
            mentionCursor: 0,
            draftTimer: null,
            draftKey: 'ticket-draft-<?php echo e($ticketPublicId); ?>',
            init() {
                try {
        ...
        @keydown.escape="mentionOpen = false">
            <div class="p-1.5 sm:p-2 relative">
                <textarea
                    ...
                    placeholder="<?php echo e($asInternalNote ? __('Ajouter une note visible uniquement par l\'équipe...') : __('Écrivez votre réponse ici...')); ?>"
                ></textarea>
                <div x-show="mentionOpen" x-cloak @click.outside="mentionOpen = false"
                    ...
                    <p x-show="filteredMentions.length === 0" class="px-3 py-2 text-xs text-slate-500"><?php echo e(__('Aucun utilisateur')); ?></p>
                </div>
            </div>
                ...
                <div class="flex items-center gap-0.5 min-w-0">
                    ...
                    <div x-data="{ emojiOpen: false }" class="relative hidden sm:block">
                        ...
                        <div x-show="emojiOpen" @click.outside="emojiOpen = false" x-cloak class="absolute bottom-full left-0 mb-1 p-1.5 rounded-lg bg-white shadow-xl border border-slate-200 grid grid-cols-8 gap-1 max-h-36 overflow-y-auto z-50 w-48">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['😀','😃','😄','😁','😅','😂','🤣','😊','😇','🙂','🙃','😉','😌','😍','🥰','😘','👍','👎','👏','🙌','👋','💪','✨','🔥','❤️','💯','✅','📎','📁','🔒']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <button type="button" @click="$wire.set('body', ($wire.get('body') || '') + '<?php echo e($emoji); ?>'); emojiOpen = false" class="p-1.5 hover:bg-slate-100 rounded-lg text-xl transition-colors"><?php echo e($emoji); ?></button>
...
</div><?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\livewire\tickets\partials\ticket-composer.blade.php ENDPATH**/ ?>