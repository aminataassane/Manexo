...
<?php if (isset($component)) { $__componentOriginal07ed7556b67851f418578e5acaf9363d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal07ed7556b67851f418578e5acaf9363d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.manexo-app-layout','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('manexo-app-layout'); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('pages.dashboard.title')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="relative overflow-hidden rounded-xl sm:rounded-2xl bg-white p-4 shadow-sm border border-slate-100 sm:p-6 lg:p-8 xl:p-10 min-[1920px]:p-12">
        <div class="relative z-10 flex flex-col items-start justify-between gap-4 sm:gap-6 sm:flex-row sm:items-center">
            ...
            <div class="flex flex-col gap-2 w-full sm:w-auto sm:flex-row sm:flex-shrink-0">
                <a href="<?php echo e(route('tickets.index')); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-3 sm:py-2.5 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-200 hover:bg-slate-50 transition-all touch-target sm:min-h-0 sm:min-w-0">
                    <iconify-icon icon="solar:list-bold" width="18"></iconify-icon>
                    <?php echo e(__('pages.dashboard.view_tickets')); ?>

                </a>
                <a href="<?php echo e(route('tickets.create')); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 sm:py-2.5 text-sm font-semibold text-white shadow-lg shadow-[var(--accent-ring)] hover:opacity-90 transition-all transform hover:-translate-y-0.5 touch-target sm:min-h-0 sm:min-w-0" style="background-color: var(--accent);">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($role, ['owner', 'admin'], true)): ?>
        <?php
            ...
            <div class="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white p-4 sm:p-5 lg:p-6 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 min-w-0">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <p class="mt-1 sm:mt-2 text-2xl sm:text-3xl min-[1920px]:text-4xl font-bold text-slate-900"><?php echo e($open); ?></p>
                    </div>
            ...
            <div class="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white p-4 sm:p-5 lg:p-6 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 min-w-0">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <p class="mt-1 sm:mt-2 text-2xl sm:text-3xl min-[1920px]:text-4xl font-bold text-slate-900"><?php echo e($inProgress); ?></p>
                    </div>
                ...
                <div class="mt-4 flex items-center text-xs font-medium text-blue-600">
                    <span class="flex items-center gap-1 bg-blue-50 px-2 py-1 rounded-full">
                        <?php echo e(__('pages.dashboard.active_now')); ?>
            ...
            <div class="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white p-4 sm:p-5 lg:p-6 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 min-w-0">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <p class="mt-1 sm:mt-2 text-2xl sm:text-3xl min-[1920px]:text-4xl font-bold text-slate-900"><?php echo e($pending); ?></p>
                    </div>
                ...
                <div class="mt-4 flex items-center text-xs font-medium text-amber-600">
                    <span class="flex items-center gap-1 bg-amber-50 px-2 py-1 rounded-full">
                        <?php echo e(__('pages.dashboard.customer_reply')); ?>
            ...
            <div class="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white p-4 sm:p-5 lg:p-6 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 min-w-0">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <p class="mt-1 sm:mt-2 text-2xl sm:text-3xl min-[1920px]:text-4xl font-bold text-slate-900"><?php echo e($resolved7d); ?></p>
                    </div>
                ...
                <div class="rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 shadow-sm border border-slate-100 min-w-0 overflow-hidden">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
                        ...
                        <div class="flex bg-slate-100 p-1 rounded-lg w-fit">
                            <button class="px-3 py-1.5 sm:py-1 text-xs font-semibold bg-white rounded-md shadow-sm text-slate-800"><?php echo e(__('pages.dashboard.days_7')); ?></button>
                            <button class="px-3 py-1.5 sm:py-1 text-xs font-medium text-slate-500 hover:text-slate-800"><?php echo e(__('pages.dashboard.days_30')); ?></button>
                        </div>
                    </div>
                    ...
                    <div class="relative h-48 sm:h-56 lg:h-64 min-[1920px]:h-72 w-full flex items-end justify-between gap-1 sm:gap-2 lg:gap-4 px-1 sm:px-2 min-w-0">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [__('pages.dashboard.weekday_mon'), __('pages.dashboard.weekday_tue'), __('pages.dashboard.weekday_wed'), __('pages.dashboard.weekday_thu'), __('pages.dashboard.weekday_fri'), __('pages.dashboard.weekday_sat'), __('pages.dashboard.weekday_sun')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php
                            ...
                            <div class="relative z-10 flex flex-col items-center gap-3 w-full group cursor-pointer">
                                <div class="relative w-full max-w-[40px] h-48 flex items-end justify-center">
                                    <div class="w-2 sm:w-3 rounded-full bg-slate-100 group-hover:bg-slate-200 transition-all duration-300" style="height: <?php echo e($h1); ?>%"></div>
                                    <div class="absolute bottom-0 w-2 sm:w-3 rounded-full transition-all duration-300 group-hover:opacity-90 shadow-lg shadow-[var(--accent-ring)]" style="background-color: var(--accent); height: <?php echo e($h2); ?>%"></div>
                                </div>
                                <span class="text-xs font-medium text-slate-400 group-hover:text-slate-600 transition-colors"><?php echo e($day); ?></span>
                            </div>
                    ...
                    <div class="responsive-table-wrap">
                        <table class="w-full text-left min-w-[600px] sm:min-w-0">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $priorityTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <?php
                                    ...
                                    <tr class="group hover:bg-slate-50/80 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('tickets.discussion', $t)); ?>'">
                                        ...
                                        <td class="px-4 sm:px-6 py-3 sm:py-4">
                                            <div class="flex items-center gap-1.5">
                                                <div class="h-2 w-2 shrink-0 rounded-full" style="background-color: <?php echo e($t->priority?->color ?? '#cbd5e1'); ?>"></div>
                                                <span class="text-sm text-slate-700"><?php echo e($t->priority?->name ?? 'Normal'); ?></span>
                                            </div>
                                        </td>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-4 p-3 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer group">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs text-slate-500 line-clamp-2 group-hover:text-slate-700"><?php echo e(__('pages.dashboard.mock_discussion_1')); ?></p>
                            </div>
                        </div>
                        <!-- Mock Item 2 -->
                        <div class="flex gap-4 p-3 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer group">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs text-slate-500 line-clamp-2 group-hover:text-slate-700"><?php echo e(__('pages.dashboard.mock_discussion_2')); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 shadow-sm border border-slate-100">
                    ...
                    <div class="relative pl-4 space-y-6 before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-100">
                        <div class="relative pl-6">
                            ...
                            <p class="text-sm font-medium text-slate-900"><?php echo e(__('pages.dashboard.ticket_resolved', ['reference' => 'TCK-01J9ZK5R'])); ?></p>
                            <p class="text-xs text-slate-500 mt-0.5"><?php echo e(__('pages.dashboard.ago_by_you', ['time' => '15 min'])); ?></p>
                        </div>
                        <div class="relative pl-6">
                            <div class="absolute left-0 top-1.5 h-2.5 w-2.5 rounded-full border-2 border-white bg-blue-500 shadow-sm"></div>
                            <p class="text-sm font-medium text-slate-900"><?php echo e(__('pages.dashboard.new_ticket_assigned')); ?></p>
                            <p class="text-xs text-slate-500 mt-0.5"><?php echo e(__('pages.dashboard.ago_by', ['time' => '45 min', 'name' => __('pages.dashboard.admin')])); ?></p>
                        </div>
                        <div class="relative pl-6">
                            <div class="absolute left-0 top-1.5 h-2.5 w-2.5 rounded-full border-2 border-white bg-slate-300 shadow-sm"></div>
                            <p class="text-sm font-medium text-slate-900"><?php echo e(__('pages.dashboard.internal_note_added')); ?></p>
                            <p class="text-xs text-slate-500 mt-0.5"><?php echo e(__('pages.dashboard.on_ticket', ['reference' => 'TCK-01J9ZK5R'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php else: ?>
        ...
        <div class="rounded-xl sm:rounded-2xl bg-white p-6 sm:p-8 lg:p-10 text-center shadow-sm border border-slate-100 min-w-0">
            ...
            <h2 class="text-lg sm:text-xl font-bold text-slate-900"><?php echo e(__('pages.dashboard.welcome_space')); ?></h2>
            <p class="mt-2 text-sm sm:text-base text-slate-500"><?php echo e(__('pages.dashboard.dashboard_loading')); ?></p>
            <div class="mt-4 sm:mt-6">
                 <a href="<?php echo e(route('tickets.index')); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl px-5 py-3 text-sm font-semibold text-white shadow-lg hover:opacity-90 transition-all touch-target sm:min-h-0 w-full sm:w-auto" style="background-color: var(--accent);">
                    <iconify-icon icon="solar:list-bold" width="18"></iconify-icon>
                    <?php echo e(__('pages.dashboard.access_my_tickets')); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal07ed7556b67851f418578e5acaf9363d)): ?>
<?php $attributes = $__attributesOriginal07ed7556b67851f418578e5acaf9363d; ?>
<?php unset($__attributesOriginal07ed7556b67851f418578e5acaf9363d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal07ed7556b67851f418578e5acaf9363d)): ?>
<?php $component = $__componentOriginal07ed7556b67851f418578e5acaf9363d; ?>
<?php unset($__componentOriginal07ed7556b67851f418578e5acaf9363d); ?>
<?php endif; ?><?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\dashboard.blade.php ENDPATH**/ ?>