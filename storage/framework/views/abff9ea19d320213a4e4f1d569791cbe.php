...
<head>
    ...
    <title>403 – <?php echo e(__('Accès refusé')); ?></title>
...
<body class="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-8" style="--accent: <?php echo e(request()->attributes->get('currentOrganization')?->primary_color ?? env('MANEXO_DEFAULT_ACCENT', '#005F02')); ?>;">
    <div class="w-full max-w-md text-center">
        ...
        <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl border border-amber-200 bg-amber-50 text-amber-600 shadow-sm">
            <iconify-icon icon="solar:lock-keyhole-bold-duotone" width="44"></iconify-icon>
        </div>

        
        <h1 class="mt-6 text-4xl font-bold tracking-tight text-slate-900">
            <span class="text-slate-400">403</span>
            <span class="mx-2 text-slate-300">|</span>
            <span><?php echo e(__('Accès refusé')); ?></span>
        </h1>
        <p class="mt-3 text-sm leading-relaxed text-slate-600">
            <?php echo e(__('Vous n\'avez pas les droits nécessaires pour accéder à cette page ou à cette action.')); ?>

        </p>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exception->getMessage() && $exception->getMessage() !== 'Forbidden' && $exception->getMessage() !== 'This action is unauthorized.'): ?>
            <p class="mt-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs text-slate-500">
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\errors\403.blade.php ENDPATH**/ ?>