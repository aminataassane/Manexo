...
<head>
    ...
    <title>419 – <?php echo e(__('Session expirée')); ?></title>
...
<body class="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-8" style="--accent: <?php echo e(request()->attributes->get('currentOrganization')?->primary_color ?? env('MANEXO_DEFAULT_ACCENT', '#005F02')); ?>;">
    <div class="w-full max-w-md text-center">
        ...
        <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl border border-violet-200 bg-violet-50 text-violet-600 shadow-sm">
        ...
        <h1 class="mt-6 text-4xl font-bold tracking-tight text-slate-900">
            <span class="text-slate-400">419</span>
            <span class="mx-2 text-slate-300">|</span>
            <span><?php echo e(__('Session expirée')); ?></span>
        </h1>
        <p class="mt-3 text-sm leading-relaxed text-slate-600">
            <?php echo e(__('Votre session a expiré. Veuillez rafraîchir la page et réessayer.')); ?>
        ...
        <div class="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <a href="javascript:location.reload()"
               class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition-colors hover:bg-slate-50">
                ...
                <?php echo e(__('Rafraîchir la page')); ?>
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\errors\419.blade.php ENDPATH**/ ?>