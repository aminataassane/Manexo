...
<?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="fb_selected_field_label" name="fb_selected_field_label" wire:model.live.debounce.150ms="fb_selected_field_label" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $fb_selected_field_options_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div class="flex items-center gap-2 group" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('option-row-{{ $idx }}', get_defined_vars()); ?>wire:key="option-row-<?php echo e($idx); ?>">
                                        <input type="text"
                                               ...
                                               wire:model.live.debounce.200ms="fb_selected_field_options_list.<?php echo e($idx); ?>"
                                               <?php if(! $canManageForms): echo 'disabled'; endif; ?>
            ...
            <div x-show="sections.general" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="space-y-5 pt-5 pb-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="fb_selected_form_name" name="fb_selected_form_name" wire:model="fb_selected_form_name" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                               class="input-builder text-xs">
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="fb_selected_form_description" name="fb_selected_form_description" wire:model="fb_selected_form_description" rows="2" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                                  class="input-builder text-xs"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['wire:model' => 'fb_selected_form_category_id','disabled' => ! $canManageForms]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'fb_selected_form_category_id','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $canManageForms)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <?php if (isset($component)) { $__componentOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['wire:model' => 'fb_selected_form_target_user_id','disabled' => ! $canManageForms]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'fb_selected_form_target_user_id','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $canManageForms)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center justify-between py-3.5 px-4 rounded-xl bg-slate-50/60">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer shrink-0 ml-3">
                            <input type="checkbox" id="fb_selected_form_creates_ticket" name="fb_selected_form_creates_ticket" wire:model="fb_selected_form_creates_ticket" class="sr-only peer" <?php if(! $canManageForms): echo 'disabled'; endif; ?>>
                            <div class="w-9 h-5 bg-slate-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[var(--accent)]/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[var(--accent)]"></div>
                        </label>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" id="fb_selected_form_due_date" name="fb_selected_form_due_date" wire:model="fb_selected_form_due_date" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                               class="input-builder text-xs">
...
<?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="datetime-local" id="fb_selected_form_expires_at" name="fb_selected_form_expires_at" wire:model="fb_selected_form_expires_at" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                               class="input-builder text-xs">
            ...
            <div x-show="sections.public" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="space-y-5 pt-5 pb-6">
                    <div class="flex items-center justify-between py-3.5 px-4 rounded-xl bg-slate-50/60">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer shrink-0 ml-3">
                            <input type="checkbox" id="fb_selected_form_public" name="fb_selected_form_public" wire:model="fb_selected_form_public" class="sr-only peer" <?php if(! $canManageForms): echo 'disabled'; endif; ?>>
                            <div class="w-9 h-5 bg-slate-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[var(--accent)]/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[var(--accent)]"></div>
                        </label>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="text" id="fb_selected_form_slug" name="fb_selected_form_slug" wire:model="fb_selected_form_slug" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="fb_selected_form_public_title" name="fb_selected_form_public_title" wire:model="fb_selected_form_public_title" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                               class="input-builder text-xs">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="fb_selected_form_public_description" name="fb_selected_form_public_description" wire:model="fb_selected_form_public_description" rows="3" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="fb_selected_form_public_thank_you" name="fb_selected_form_public_thank_you" wire:model="fb_selected_form_public_thank_you" rows="3" <?php if(! $canManageForms): echo 'disabled'; endif; ?>
                                  class="input-builder text-xs"
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views/livewire/admin/form-builder-properties.blade.php ENDPATH**/ ?>