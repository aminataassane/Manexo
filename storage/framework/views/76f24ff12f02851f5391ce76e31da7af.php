...
<head>
    ...
    <title>500 – <?php echo e(__('Erreur serveur')); ?></title>
...
<body class="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-8" style="--accent: <?php echo e(request()->attributes->get('currentOrganization')?->primary_color ?? env('MANEXO_DEFAULT_ACCENT', '#005F02')); ?>;">
    <div class="w-full max-w-md text-center">
        ...
        <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl border border-red-200 bg-red-50 text-red-600 shadow-sm">
            <iconify-icon icon="solar:bug-bold-duotone" width="44"></iconify-icon>
        </div>
        ...
        <h1 class="mt-6 text-4xl font-bold tracking-tight text-slate-900">
            ...
            <span><?php echo e(__('Erreur serveur')); ?></span>
        </h1>
        <p class="mt-3 text-sm leading-relaxed text-slate-600">
            <?php echo e(__('Une erreur inattendue s\'est produite. Notre équipe a été notifiée et travaille à résoudre le problème.')); ?>
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\errors\500.blade.php ENDPATH**/ ?>