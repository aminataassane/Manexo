...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a
                    href="<?php echo e(route('organizations.select')); ?>"
                    class="me-4 text-sm text-gray-600 hover:text-[color:var(--accent)] transition-colors"
                    title="Switch organization"
                >
                    <?php echo e($currentOrganization->name ?? __('No organization')); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tickets.index'),'active' => request()->routeIs('tickets.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
</nav><?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\livewire\layout\navigation.blade.php ENDPATH**/ ?>