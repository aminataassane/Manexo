    ...
    <div class="fade-in shadow-slate-200/50 sm:p-6 sm:w-[120%] sm:-ml-[10%] bg-white w-full border-slate-100 border rounded-xl p-5 shadow-2xl">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($error)): ?>
            ...
            <div class="text-center py-4">
                ...
                <h1 class="font-serif text-lg font-medium tracking-tight text-slate-900 mb-2"><?php echo e(__('invitations.accept_title')); ?></h1>
                    ...
                    <div class="mt-4">
                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                            ...
                            <button type="submit" class="inline-flex items-center gap-2 rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 transition-colors">
                                ...
                                <?php echo e(__('invitations.logout_and_login')); ?>
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('home')); ?>" class="text-sm font-medium text-[#005F02] hover:underline"><?php echo e(__('Back')); ?></a>
                </div>
            </div>
        <?php elseif(!empty($invitation)): ?>
            ...
            <div class="text-center py-2">
                ...
                <h1 class="font-serif text-lg font-medium tracking-tight text-[#002e01] mb-2"><?php echo e(__('invitations.accept_title')); ?></h1>
                <p class="text-sm text-slate-600 mb-1">
                    <?php echo e(__('invitations.accept_desc', ['org' => $invitation->organization->name, 'role' => $invitation->role])); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invitation->inviter): ?>
                    <p class="text-xs text-slate-400"><?php echo e(__('invitations.invited_by', ['name' => $invitation->inviter->name])); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <form method="POST" action="<?php echo e(route('invitations.process-accept', ['token' => $invitation->token])); ?>" class="mt-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\invitations\accept.blade.php ENDPATH**/ ?>