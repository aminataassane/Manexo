...
<head>
    ...
    <title><?php echo e(__('platform_invitations.email_subject')); ?></title>
    <style>
...
<body style="margin:0; padding:0; background-color:#f4f7f5; width:100%;">
    ...
    <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all;">
        <?php echo e(__('platform_invitations.email_preheader', ['inviter' => $inviterName, 'role' => $roleName])); ?>
                                                ...
                                                <td style="vertical-align:middle; padding-right:14px;">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($logoUrl)): ?>
                                                        <table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="width:38px; height:38px; border-radius:10px; background-color:#ffffff; border:1px solid rgba(0,95,2,0.12); overflow:hidden;">
                                                            <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($appName); ?>" width="38" height="38" style="width:38px; height:38px; object-fit:contain; display:block;">
                                                        </td></tr></table>
                                                    <?php else: ?>
                                ...
                                <tr>
                                    <td style="padding:28px 32px 0 32px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
                                        ...
                                        <div style="font-size:23px; font-weight:700; color:#111827; letter-spacing:-0.4px; line-height:1.3;">
                                            <?php echo e(__('platform_invitations.email_heading')); ?>
                                        ...
                                        <div style="margin-top:16px; font-size:15px; line-height:1.7; color:#4b5563;">
                                            Bonjour,<br><br>
                                            <strong style="color:#111827;"><?php echo e($inviterName); ?></strong>
                                            <?php echo e(__('platform_invitations.email_body_text', ['role' => $roleName])); ?>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background-color:#f0fdf4; border-radius:12px; border:1px solid #bbf7d0;">
                                            <tr>
                                                <td style="padding:16px 20px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
                                                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td style="font-size:13px; color:#6b7280;"><?php echo e(__('platform_invitations.email_role_label')); ?></td>
                                                            <td align="right" style="font-size:14px; font-weight:600; color:#005F02;"><?php echo e($roleName); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td style="padding:16px 32px 0 32px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
                                        <div style="font-size:14px; line-height:1.7; color:#6b7280;">
                                            <?php echo e(__('platform_invitations.email_body_desc')); ?>
                                ...
                                <tr>
                                    <td align="center" style="padding:28px 32px 8px 32px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="border-radius:12px; background-color:#005F02;">
                                                    <a href="<?php echo e($acceptUrl); ?>" target="_blank" style="display:inline-block; padding:14px 40px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; font-size:15px; font-weight:600; color:#ffffff; text-decoration:none; border-radius:12px; mso-padding-alt:0;">
                                                        <!--[if mso]><i style="mso-font-width:150%; mso-text-raise:22pt;">&nbsp;</i><![endif]-->
                                                        <span style="mso-text-raise:11pt;"><?php echo e(__('platform_invitations.email_cta')); ?></span>
                                        ...
                                        <div style="margin-top:14px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; font-size:13px; color:#6b7280;">
                                            <?php echo e(__('platform_invitations.email_expires')); ?>
                                            ...
                                            <tr>
                                                <td style="padding:14px 16px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
                                                    <div style="font-size:12px; color:#6b7280; line-height:1.5;">
                                                        <?php echo e(__('platform_invitations.email_fallback')); ?>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="font-size:12px; line-height:1.6; color:#9ca3af;">
                                        &copy; <?php echo e(date('Y')); ?> <?php echo e($appName); ?> &mdash; <?php echo e(__('platform_invitations.email_rights')); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding-top:8px; font-size:11px; color:#d1d5db;">
                                        <?php echo e(__('platform_invitations.email_auto')); ?>
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\emails\platform-invitation.blade.php ENDPATH**/ ?>