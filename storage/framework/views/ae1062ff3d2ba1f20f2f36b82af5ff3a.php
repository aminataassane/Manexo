...
<head>
    ...
    <title><?php echo e(__('invitations.accepted_email_subject', ['name' => $acceptedByName, 'org' => $organizationName])); ?></title>
    <style>
...
<body style="margin:0; padding:0; background-color:#f4f7f5; width:100%;">
    ...
    <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all;">
        <?php echo e(__('invitations.accepted_email_preheader', ['name' => $acceptedByName, 'org' => $organizationName, 'role' => $roleName])); ?>
                                ...
                                <tr>
                                    <td style="padding:28px 32px 0 32px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
                                        ...
                                        <div style="font-size:23px; font-weight:700; color:#111827; letter-spacing:-0.4px; line-height:1.3;">
                                            <?php echo e(__('invitations.accepted_email_heading')); ?>
                                        ...
                                        <div style="margin-top:16px; font-size:15px; line-height:1.7; color:#4b5563;">
                                            Bonjour,<br><br>
                                            <strong style="color:#111827;"><?php echo e($acceptedByName); ?></strong>
                                            <?php echo e(__('invitations.accepted_email_body', ['org' => $organizationName, 'role' => $roleName])); ?>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background-color:#f0fdf4; border-radius:12px; border:1px solid #bbf7d0;">
                                            <tr>
                                                <td style="padding:16px 20px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
                                                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td style="font-size:13px; color:#6b7280;"><?php echo e(__('invitations.accepted_email_member_label')); ?></td>
                                                            <td align="right" style="font-size:14px; font-weight:600; color:#111827;"><?php echo e($acceptedByName); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding-top:4px;"><div style="height:1px; background-color:#dcfce7;"></div></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top:4px; font-size:13px; color:#6b7280;"><?php echo e(__('invitations.accepted_email_email_label')); ?></td>
                                                            <td align="right" style="padding-top:4px; font-size:14px; font-weight:500; color:#4b5563;"><?php echo e($acceptedByEmail); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding-top:4px;"><div style="height:1px; background-color:#dcfce7;"></div></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top:4px; font-size:13px; color:#6b7280;"><?php echo e(__('invitations.email_org_label')); ?></td>
                                                            <td align="right" style="padding-top:4px; font-size:14px; font-weight:600; color:#111827;"><?php echo e($organizationName); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding-top:4px;"><div style="height:1px; background-color:#dcfce7;"></div></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top:4px; font-size:13px; color:#6b7280;"><?php echo e(__('invitations.email_role_label')); ?></td>
                                                            <td align="right" style="padding-top:4px; font-size:14px; font-weight:600; color:#005F02;"><?php echo e($roleName); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="border-radius:12px; background-color:#005F02;">
                                                    <a href="<?php echo e($dashboardUrl); ?>" target="_blank" style="display:inline-block; padding:14px 40px; font-family:'Mona Sans','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; font-size:15px; font-weight:600; color:#ffffff; text-decoration:none; border-radius:12px; mso-padding-alt:0;">
                                                        <!--[if mso]><i style="mso-font-width:150%; mso-text-raise:22pt;">&nbsp;</i><![endif]-->
                                                        <span style="mso-text-raise:11pt;"><?php echo e(__('invitations.accepted_email_cta')); ?></span>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="font-size:12px; line-height:1.6; color:#9ca3af;">
                                        &copy; <?php echo e(date('Y')); ?> <?php echo e($appName); ?> &mdash; <?php echo e(__('invitations.email_rights')); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding-top:8px; font-size:11px; color:#d1d5db;">
                                        <?php echo e(__('invitations.email_auto')); ?>
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\emails\invitation-accepted.blade.php ENDPATH**/ ?>