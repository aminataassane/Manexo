...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('pages.profile.title')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight"><?php echo e(__('pages.profile.heading')); ?></h1>
            <p class="text-sm text-slate-500 mt-1"><?php echo e(__('pages.profile.subheading')); ?></p>
        </div>
    </div>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-611564392-0', $key);
...
?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingInvitations->isNotEmpty()): ?>
                <div class="rounded-2xl border border-cyan-200 bg-gradient-to-br from-cyan-50/60 to-white shadow-sm overflow-hidden">
                    <div class="px-6 py-4 border-b border-cyan-100 bg-cyan-50/50 flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-slate-900"><?php echo e(__('invitations.pending_title')); ?></h2>
                            <p class="text-xs text-slate-500 mt-0.5"><?php echo e($pendingInvitations->count()); ?> <?php echo e(trans_choice('invitations.pending_count_label', $pendingInvitations->count())); ?></p>
                        </div>
                    </div>
                            ...
                            <div class="px-6 py-4 flex flex-col sm:flex-row sm:items-center gap-4">
                                <div class="flex items-center gap-4 min-w-0 flex-1">
                                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl font-bold text-sm shadow-sm"
                                         style="background: <?php echo e($inv->organization?->primary_color ? 'color-mix(in srgb, '.$inv->organization->primary_color.' 15%, white)' : '#e0f2fe'); ?>; color: <?php echo e($inv->organization?->primary_color ?: '#0891b2'); ?>;">
                                        <?php echo e($invInitial); ?>

                                    </div>
                                    <div class="min-w-0">
                                        <p class="text-sm font-bold text-slate-900 truncate"><?php echo e($inv->organization?->name ?? '—'); ?></p>
                                        <div class="flex flex-wrap items-center gap-2 mt-1">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inv->inviter): ?>
                                                <span class="text-[11px] text-slate-500"><?php echo e(__('invitations.invited_by', ['name' => $inv->inviter->name])); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <span class="text-[11px] text-cyan-600 font-medium"><?php echo e(__('invitations.expires_in', ['days' => $daysLeft])); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2 shrink-0">
                                    <a href="<?php echo e(route('invitations.accept', ['token' => $inv->token])); ?>"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden" x-data="{ open: true }">
                ...
                <div x-show="open" x-collapse>
                    <div class="p-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $loadActivity): ?>
                        ...
                        <?php else: ?>
                            <div class="flex flex-wrap gap-2 mb-6">
                                <?php $filters = [['all', 'filter_all'], ['tickets', 'filter_tickets'], ['commentaires', 'filter_comments'], ['assignations', 'filter_assignations']]; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$key, $labelKey]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <?php
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div class="relative pl-8">
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1">
                                            <p class="text-sm font-medium text-slate-900"><?php echo e($e['label']); ?></p>
                                            <span class="text-xs text-slate-400"><?php echo e(\Illuminate\Support\Carbon::parse($e['at'])->diffForHumans()); ?></span>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1">
                                            <span class="font-mono text-slate-400">#<?php echo e($e['ticket_id']); ?></span> · <?php echo e($e['subject']); ?>
                                        ...
                                        <div class="mt-2">
                                            <span class="inline-flex items-center rounded-md bg-slate-100 px-2 py-1 text-[10px] font-medium text-slate-600 ring-1 ring-inset ring-slate-500/10">
                                                <?php echo e($statusLabel($e['status'])); ?>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <a href="<?php echo e(route('locale.switch', 'fr')); ?>" 
                       class="flex items-center justify-center gap-2 rounded-xl border p-2 text-sm font-medium transition-all <?php echo e($currentLocale === 'FR' ? 'border-[var(--accent)] bg-[var(--accent-soft)]/10 text-[var(--accent)]' : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50'); ?>">
                        <span class="text-lg">🇫🇷</span> <?php echo e(__('pages.profile.french')); ?>

                    </a>
                    <a href="<?php echo e(route('locale.switch', 'en')); ?>" 
                       class="flex items-center justify-center gap-2 rounded-xl border p-2 text-sm font-medium transition-all <?php echo e($currentLocale === 'EN' ? 'border-[var(--accent)] bg-[var(--accent-soft)]/10 text-[var(--accent)]' : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50'); ?>">
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-611564392-1', $key);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-611564392-2', $key);
...
<?php endif; ?>
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views\profile.blade.php ENDPATH**/ ?>