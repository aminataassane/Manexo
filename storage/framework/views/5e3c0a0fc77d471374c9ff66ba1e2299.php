                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stepData['fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <div class="<?php echo e($colSpan); ?> min-w-0">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'textarea'): ?>
                                <textarea wire:model.blur="answers.<?php echo e($key); ?>" rows="4"
                            ...
                            <?php elseif($type === 'number'): ?>
                                <input type="number" wire:model.blur="answers.<?php echo e($key); ?>" placeholder="<?php echo e($placeholder ?: $field->label); ?>"
                            ...
                            <?php elseif($type === 'email'): ?>
                                <input type="email" wire:model.blur="answers.<?php echo e($key); ?>" placeholder="<?php echo e($placeholder ?: $field->label); ?>"
                                       class="input-manexo w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-[var(--accent)] focus:border-[var(--accent)]">
                            ...
                            <?php else: ?>
                                <input type="text" wire:model.blur="answers.<?php echo e($key); ?>" placeholder="<?php echo e($placeholder ?: $field->label); ?>"
                                       class="input-manexo w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-[var(--accent)] focus:border-[var(--accent)]">
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.manexo.action-button','data' => ['type' => 'submit','wireTarget' => 'submit','variant' => 'primary','class' => '!rounded-lg !px-5 touch-manipulation !font-bold','style' => 'background-color: var(--accent);','loadingLabel' => __('Envoi...')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','wire-target' => 'submit','variant' => 'primary','class' => '!rounded-lg !px-5 touch-manipulation !font-bold','style' => 'background-color: var(--accent);','loading-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Envoi...'))]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
