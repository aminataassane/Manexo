...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1147721002-0', $key);
        ...
        <div class="relative ml-2" x-data="{ open: false }">
            ...
            >
                ...
                <div class="hidden text-left md:block">
                    <p class="text-sm font-semibold text-slate-900 leading-none"><?php echo e($user?->name); ?></p>
                    <p class="text-xs text-slate-500 mt-0.5 leading-none"><?php echo e($roleLabel); ?></p>
                </div>
...
<?php /**PATH C:\Users\Aminata_an\OneDrive\Bureau\QUALITY_CENTER\Manexo\manexo\resources\views/components/manexo/topbar.blade.php ENDPATH**/ ?>