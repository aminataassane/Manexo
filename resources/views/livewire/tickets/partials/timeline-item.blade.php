...
@if($isSystem)
    <div class="relative py-2">
        ...
        <div class="pl-2 flex items-center gap-2 text-sm text-slate-700">
            {!! $bodyFormatted !!}
...
@elseif($isNote)
    <div class="relative group py-3">
        ...
        <div class="pl-2">
            <div class="bg-[#FFF7ED] border border-amber-200 rounded-xl p-4">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-[10px] text-amber-600">{{ $msg->user?->name }} • {{ $time }}</span>
                </div>
                <div class="text-sm sm:text-base leading-relaxed text-amber-900">
                    {!! $bodyFormatted !!}
                </div>
    ...
    @else
        <div class="relative py-4">
            ...
            <div class="pl-2 pr-2">
                ...
                <div class="rounded-2xl rounded-bl-md px-4 py-3 text-sm sm:text-base leading-relaxed bg-white border border-slate-200 text-slate-700 shadow-sm break-words">
                    {!! $bodyFormatted !!}
                    @if(count($messageAttachments) > 0)
                        <div class="mt-2 pt-2 border-t border-[#E5E7EB] space-y-1.5">
                            @foreach($messageAttachments as $att)
