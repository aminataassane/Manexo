                            ...
                            <td class="px-5 py-3.5 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    @if (($org->status ?? 'active') === 'active')
                                        <button wire:click="openEnterModal({{ $org->id }})" class="inline-flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-xs font-medium text-indigo-600 hover:bg-indigo-50 transition-colors">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm" wire:keydown.escape="$set('showSuspendModal', false)">
            <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl" @click.outside="$wire.set('showSuspendModal', false)">
                ...
                <div class="flex justify-end gap-2">
                    <button wire:click="$set('showSuspendModal', false)" class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
    ...
    @if ($showEnterModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm" wire:keydown.escape="$set('showEnterModal', false)">
            <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl" @click.outside="$wire.set('showEnterModal', false)">
                ...
                <div class="flex justify-end gap-2">
                    <button wire:click="$set('showEnterModal', false)" class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                        {{ __('super_admin.cancel') }}
                    </button>
                    <button wire:click="confirmEnter" class="rounded-xl bg-indigo-500 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-600 transition-colors">
    ...
    @if ($showActivateModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm" wire:keydown.escape="$set('showActivateModal', false)">
            <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl" @click.outside="$wire.set('showActivateModal', false)">
                ...
                <div class="flex justify-end gap-2">
                    <button wire:click="$set('showActivateModal', false)" class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                        {{ __('super_admin.cancel') }}
                    </button>
    ...
    @if ($showDisableModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm" wire:keydown.escape="$set('showDisableModal', false)">
            <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl" @click.outside="$wire.set('showDisableModal', false)">
                ...
                <div class="flex justify-end gap-2">
                    <button wire:click="$set('showDisableModal', false)" class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                        {{ __('super_admin.cancel') }}
                    </button>
